...
最新版 v1.4.2 (2025-02-19)

| リンク                                                                                                      | 説明                                   |
| ----------------------------------------------------------------------------------------------------------- | -------------------------------------- |
| [フォント (Meroit)](https://github.com/omonomo/Meroit/releases/download/v1.4.2/Meroit_v1.4.2.zip)           | 通常版。半角幅が全角の1/2。            |
| [フォント (MeroitLoose)](https://github.com/omonomo/Meroit/releases/download/v1.4.2/MeroitLoose_v1.4.2.zip) | 文字間隔ゆるい版。半角幅が全角の9/16。 |
| [ソースコード](https://github.com/omonomo/Meroit/archive/refs/tags/v1.4.2.zip)                              | 使用方法は下の方にあります。           |
...
- [全角英数や半角カナが判別しやすい、文字間隔調整機能付き等幅フォント「Soroit」](https://omonomo.github.io/Soroit/): 三つ下の妹さんフォントです。
